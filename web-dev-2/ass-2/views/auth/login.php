...
<head>
  ...
  <title>ElderCare - Welcome Back</title>
...
<body class="auth-layout">
  ...
  <div class="auth-card">
    <div class="auth-header">
      ...
      <p class="auth-subtitle">Sign in to access your ElderCare account</p>
    </div>
    ...
    <form action="index.php?action=login" method="POST">
      <div class="form-group">
        ...
        <div class="input-icon-wrapper">
          ...
          <input type="email" id="email" name="email" class="input-with-icon" placeholder="Enter your email"
      ...
      <div class="form-group">
        ...
        <div class="input-icon-wrapper">
          ...
          <input type="password" id="password" name="password" class="input-with-icon"
            placeholder="Enter your password">
        </div>
      </div>

      <div
        style="display: flex; justify-content: space-between; align-items: center; margin-top: -0.5rem; margin-bottom: 1.5rem;">
        <label style="display: flex; align-items: center; color: #64748b; font-size: 0.85rem; cursor: pointer;">
          <input type="checkbox" name="remember" style="margin-right: 0.5rem; width: fit-content;" <?php echo !empty($savedEmail) ? 'checked' : '' ?>>
          <p>Remember me</p>
        </label>
        <a href="#" style="color: #64748b; font-size: 0.85rem; text-decoration: none; font-weight: 600;">Forgot
          Password?</a>
      </div>
